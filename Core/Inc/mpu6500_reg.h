...
#define MPU6500_ACCEL_FS_2G 		(0b00)
#define MPU6500_ACCEL_FS_4G 		(0b01)
#define MPU6500_ACCEL_FS_8G 		(0b10)
#define MPU6500_ACCEL_FS_16G 		(0b11)

#define MPU6500_GYRO_FS_250DPS		(0b00)
#define MPU6500_GYRO_FS_500DPS		(0b01)
#define MPU6500_GYRO_FS_1000DPS		(0b10)
#define MPU6500_GYRO_FS_2000DPS		(0b11)
